...
export class MentionsListComponent<T> implements MentionsList<T> {
  @Output()
  ...
  protected checkBounds(): void {
    ...
    const bounds: ClientRect = (this.list
  ...
  protected getBlockCursorDimensions(
    nativeParentElement: HTMLInputElement,
